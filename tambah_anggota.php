...
<form method="post" action="aksi_tambah_anggota.php">
	<br>
				...
				<input class="form-control" id="ex3" type="text" name="nama">
				<br>
				...
				<input class="form-control" id="ex3" type="text" name="telepon">
				<br>
				...
				<label for="ex2">Status Aktif</label>
				<input class="form-control" id="ex3" type="text" name="status_aktif">
				<br>
